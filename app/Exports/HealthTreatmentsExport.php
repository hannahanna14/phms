...
class HealthTreatmentsExport implements FromCollection, WithHeadings, WithMapping, WithTitle, ShouldAutoSize
{
    protected $filters;
    ...
    {
        $query = HealthTreatment::with('student')
